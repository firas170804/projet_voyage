 ...
 */
final class Version20250517001949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vol ADD destination VARCHAR(255) NOT NULL, ADD depart VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vol DROP destination, DROP depart
        SQL);
    }
}
